 ...
 * - Полная форма с полями для прямого и обратного аукциона
 * - Добавлены поля: 3D-эффект, цена мгновенной покупки
 * - Подключение общих header/footer
 * - Предпросмотр фото, валидация, отправка на API
 */
session_start();
...
<script>
    ...
    // Расчёт платы за размещение (50 руб. для обоих типов)
