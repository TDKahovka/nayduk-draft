 ...
 * - Мои аукционы (созданные)
 * - Мои ставки (где участвую)
 * - Ожидающие подтверждения сделки (покупки и продажи)
 * - Кнопки: подтвердить сделку, перевыставить бесплатно, продать победителю, удалить
 */
session_start();
